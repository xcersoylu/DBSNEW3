...
*gönderilmemişler
    SELECT bsid~companycode,
           ...
           dats_add_days( bsid~duecalculationbasedate , CAST( CAST( bsid~cashdiscount1days AS CHAR( 5 ) ) AS INT4 ) ) AS invoiceduedate_org,
           bsid~NetDueDate,
...
*             dats_add_days( bseg~duecalculationbasedate , CAST( CAST( bseg~cashdiscount1days AS CHAR( 5 ) ) AS INT4 ) ) AS invoiceduedate,
             dats_add_days( bseg~duecalculationbasedate , CAST( CAST( bseg~cashdiscount1days AS CHAR( 5 ) ) AS INT4 ) ) AS invoiceduedate_org,
