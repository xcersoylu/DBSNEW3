       ...
       '<soapenv:Body>'
          '<tem:FaturaYukle>'
            '<tem:fatura>'
                ...
                '<tem:pesinParaBirimi>' ms_invoice_data-transactioncurrency '</tem:pesinParaBirimi>'
                '<tem:vadeliTutar>' lv_amount '</tem:vadeliTutar>'
                '<tem:vadeliParaBirimi>' ms_invoice_data-transactioncurrency '</tem:vadeliParaBirimi>'
